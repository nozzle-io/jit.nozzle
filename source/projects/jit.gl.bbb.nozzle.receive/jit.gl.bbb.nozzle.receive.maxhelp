{
	"patcher" : {
		...
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 30, 450, 20], "text" : "jit.gl.bbb.nozzle.receive — Receive OpenGL textures via nozzle" } },
			...
			{ "box" : { "id" : "obj-12", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 2, "outlettype" : [ "", "" ], "patching_rect" : [50, 160, 320, 22], "text" : "jit.gl.bbb.nozzle.receive @name myStream @timeout 0" } },
			...
			{ "box" : { "id" : "obj-40", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 490, 350, 20], "text" : "See also: jit.gl.bbb.nozzle.send" } },
