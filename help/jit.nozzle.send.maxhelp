{
	"patcher" : {
		...
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 30, 400, 20], "text" : "jit.bbb.nozzle.send — Publish jit.matrix data via nozzle" } },
			...
			{ "box" : { "id" : "obj-12", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 1, "outlettype" : [ "" ], "patching_rect" : [50, 160, 320, 22], "text" : "jit.bbb.nozzle.send @name myStream" } },
			...
			{ "box" : { "id" : "obj-50", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 450, 350, 20], "text" : "See also: jit.bbb.nozzle.receive" } }
		],
		"lines" : [
