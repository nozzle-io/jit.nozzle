{
	"patcher" : {
		...
		"enablevscroll" : 1,
		"devicewidth" : 0,
		"description" : "Receive GPU textures via nozzle",
		"digest" : "Connects to a named shared texture stream and receives frames",
		"tags" : "nozzle, texture, sharing, gpu",
		"style" : "",
		"subpatcher_template" : "",
		"assistshowspatchername" : 0,
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 30, 400, 20], "text" : "bbb.nozzle.receive — Receive GPU textures via nozzle" } },
			{ "box" : { "id" : "obj-2", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 55, 400, 20], "text" : "Connects to a named sender and polls for new texture frames" } },
			...
			{ "box" : { "id" : "obj-12", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 2, "outlettype" : [ "", "" ], "patching_rect" : [50, 160, 280, 22], "text" : "bbb.nozzle.receive @name myStream @timeout 0" } },

			{ "box" : { "id" : "obj-13", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [350, 160, 200, 20], "text" : "← left: width height frame_index" } },

			{ "box" : { "id" : "obj-14", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [50, 200, 100, 22], "text" : "print frame" } },
			{ "box" : { "id" : "obj-15", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [160, 200, 250, 20], "text" : "← outputs: width height frame_index" } },
			...
			{ "box" : { "id" : "obj-31", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 420, 400, 40], "text" : "bang → poll for new frame (outputs width height frame_index on left outlet)\nconnect → reconnect to sender\ninfo → print sender details to console" } },

			{ "box" : { "id" : "obj-40", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 490, 350, 20], "text" : "See also: bbb.nozzle.send" } },
