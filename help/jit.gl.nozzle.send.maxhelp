{
	"patcher" : {
		...
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 30, 450, 20], "text" : "jit.gl.nozzle.send — Publish OpenGL textures via nozzle" } },
			...
			{ "box" : { "id" : "obj-11", "maxclass" : "newobj", "numinlets" : 1, "numoutlets" : 1, "outlettype" : [ "" ], "patching_rect" : [50, 125, 180, 22], "text" : "jit.gl.nozzle.send @name myStream" } },
			...
			{ "box" : { "id" : "obj-50", "maxclass" : "comment", "numinlets" : 0, "numoutlets" : 0, "patching_rect" : [50, 480, 350, 20], "text" : "See also: jit.gl.nozzle.receive" } }
		],
		"lines" : [
